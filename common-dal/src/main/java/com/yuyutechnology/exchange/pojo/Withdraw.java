...
// Generated Mar 17, 2017 4:54:53 PM by Hibernate Tools 5.2.1.Final
...
public class Withdraw implements java.io.Serializable {
	...
	public Withdraw(int userId, String areaCode, String userPhone, String transferId, int reviewStatus,
			int goldpayRemit) {
		this.userId = userId;

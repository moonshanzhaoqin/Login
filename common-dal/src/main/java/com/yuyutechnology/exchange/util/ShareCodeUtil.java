...
public class ShareCodeUtil {
	...
	private static final char[] r = new char[] { 'F', 'V', 'E', '8', 'A', 'G', '2', 'D', 'Z', 'W', '9', 'C', '7', 'P',
			'5', 'K', 'I', '6', 'M', 'J', 'U', 'Q', 'R', '4', 'X', 'Y', 'L', 'T', 'N', '3', 'B', 'S', 'H' };
...
//		System.out.println(toSerialCode(37591));
		// System.out.println(codeToId("2VOQMNU7IE"));

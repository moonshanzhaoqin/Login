 ...
 */
@Entity
@Table(name = "e_user_invite", catalog = "anytime_exchange")
public class EUserInvite implements java.io.Serializable {
	...
	public EUserInvite(int userId, int inviteQuantity, BigDecimal inviteBonus) {
		this.userId = userId;

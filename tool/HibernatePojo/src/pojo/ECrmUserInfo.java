 ...
 */
@Entity
@Table(name = "e_crm_user_info", catalog = "test_exchange")
public class ECrmUserInfo implements java.io.Serializable {
	...
	public ECrmUserInfo(long userId, String areaCode, String userPhone, String userName, Integer userType,
			Integer userAvailable, int loginAvailable, int payAvailable, BigDecimal userTotalAssets, Date updateAt) {
		this.userId = userId;

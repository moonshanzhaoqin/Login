...
public class AccountingDAO {
	...
	public Integer accountingWalletSeq(final long seqIdStart, final long seqIdEnd, final Date stareDate,
			final Date endDate) {
		return hibernateTemplate.executeWithNativeSession(new HibernateCallback<Integer>() {
			@Override
			public Integer doInHibernate(Session session) throws HibernateException {
	...
	public Long getMAXSeqId4WalletBeforeByUserIdAndCurrency(final int userId, final String currency) {
		return hibernateTemplate.executeWithNativeSession(new HibernateCallback<Long>() {
			@Override
			public Long doInHibernate(Session session) throws HibernateException {
	...
	public Object[] calculatorWalletSeqByUserIdAndCurrency(final long seqIdStart, final long seqIdEnd, final int userId, final String currency) {

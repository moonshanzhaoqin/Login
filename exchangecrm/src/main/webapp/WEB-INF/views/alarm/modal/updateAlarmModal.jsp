	...
	<div class="modal fade" id="updateAlarmModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="updateAlarmConfig" method="POST"
					action="<c:url value="/alarm/updateAlarmConfigInfo" />">

					<input class="form-control" name="alarmId" type="hidden"
						id="updateAlarmId" /> <input class="form-control" name="alarmType"
						type="hidden" id="updateAlarmType" />
					...
					<div class="modal-body">
						...
						<div class="row" id="updateLimitConfig">
							...
							<div class="col-md-3">
								<div class="input-group">
									<input type="text" class="form-control"
										name="criticalThresholdLowerLimit" id="updateLowerLimit" /> <span
							...
							<div class="col-md-3">
								<div class="input-group">
									<input type="text" class="form-control"
										name="criticalThresholdUpperLimit" id="updateUpperLimit" /> <span
										class="input-group-addon">%</span>
								</div>
							...
							<div class="col-md-4">
								<div class="input-group">
									<input type="text" class="form-control"
										...
										id="updatePercentageWarning" /> <span
										class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="row">
								...
								<div class="col-md-8" id="updateSupervisorGroup"></div>
							</div>
						</div>
					</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary submit"
							id="updateAlarmConfigBtn">确认</button>
					</div>
				</form>
			</div>
		</div>

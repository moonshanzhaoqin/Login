...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<form class="form-signin form" role="form"
				action="<c:url value='/dologin' />" method="post">
				<div class="col-md-12"
					style="height: 400px; width: 320px; background-color: #999; border-radius: 10px;">

					<!--标题-->
					<div class="row"
						style="height: 65px; background-color: #C8C8C8; border-top-left-radius: 10px; border-top-right-radius: 10px;">
						<h2 class="form-signin-heading text-center">登录</h2>
					</div>

					<!--输入框-->
					<div class="row center-block"
						style="height: 175px; width: 100%; margin-top: 15px;">
						<div class="inner-addon left-addon ">
							<span class="glyphicon glyphicon-envelope"></span> <input
								name="adminName" type="text" class="form-control adminName"
								placeholder="Admin Name" style="border: 0px; height: 40px;" />
						</div>
						<br />
						<div class="inner-addon left-addon">
					...
					<!--登录按钮-->
					<div class="row"
						style="height: 145px; background-color: #D4D4D4; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
						<button class="btn btn-lg btn-default btn-block login"
							type="button"
							style="width: 280px; text-align: center; margin: auto; margin-top: 30px;">确认</button>
		...
		<div class="row">
			...
			<input id="retMessage" name="retMessage" value="${message}"
				type="hidden">
		</div>
	</div>
	<!--end of container-->

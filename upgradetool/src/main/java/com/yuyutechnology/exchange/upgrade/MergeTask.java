...
public class MergeTask {
	...
	public void upgradeTask() {
		...
		upgradeManager.registerAccount("+86", feeAccount, "feeAccount", feeAccount, ServerConsts.USER_TYPE_OF_FEE);
		//回收账号  type 3
		logger.info("create recoveryAccount");
		upgradeManager.registerAccount("+86", recoveryAccount, "recoveryAccount", recoveryAccount, ServerConsts.USER_TYPE_OF_RECOVERY);
		//冻结账户  type 4
		logger.info("create frozenAccount");
		upgradeManager.registerAccount("+86", frozenAccount, "frozenAccount", frozenAccount, ServerConsts.USER_TYPE_OF_FROZEN);

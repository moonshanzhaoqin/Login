...
public class LoggedInUserController {
	...
	// "")
	// @RequestMapping(value = "/token/{token}/user/modifyPayPwdByGoldpay",
	// method = RequestMethod.POST, produces = "application/json;
	// charset=utf-8")
	// public ModifyPayPwdByGoldpayResponse modifyPayPwdByGoldpay(@PathVariable
	// String token,
	...
	// } else {
	// SessionData sessionData = SessionDataHolder.getSessionData();
	// if (userManager.checkGoldpayPwd(sessionData.getUserId(),
	// modifyPayPwdByGoldRequest.getGoldpayPwd())) {
	// // PayPwd 6位数字
	...
	// modifyPayPwdByGoldRequest.getNewUserPayPwd());
	// logger.info("********Operation succeeded********");
	// rep.setRetCode(RetCodeConsts.RET_CODE_SUCCESS);
	// rep.setMessage(MessageConsts.RET_CODE_SUCCESS);
	// } else {

...
public class LanguageTest extends BaseSpringJunit4 {
	...
	// System.out.println(simpleDateFormat.parse(redisDAO.getValueByKey("123")).getTime()
	// - new Date().getTime());
	...
	// System.out.println(configManager.getConfigStringValue(ConfigKeyEnum.VERIFYTIME,
	// "10"));
	// System.out.println(configManager.getConfigStringValue(ConfigKeyEnum.REFUNTIME,
	// "7"));
